...
def parsers(model):
    ...
    parser.add_argument("--bert_pred", type=str, default=r"D:\sdsQA\chatbot\berttcnn\bert-base-chinese", help="bert 预训练模型")
    ...
    parser.add_argument("--save_model_best", type=str, default=os.path.join(r"D:\sdsQA\chatbot\berttcnn\model", f"best_model{model}.pth"))
    parser.add_argument("--save_model_last", type=str, default=os.path.join(r"D:\sdsQA\chatbot\berttcnn\model", f"last_model{model}.pth"))
