...
class MyDataset(TextClassificationDataset):
    ...
    def __init__(self, tokenizer, max_seq_len: int = 128, mode: str = 'train'):
        if mode == 'train':
            data_file = '抑郁患者语录-训练.tsv'
        elif mode == 'test':
            data_file = '抑郁患者语录-测试.tsv'
        else:
            data_file = '抑郁患者语录-验证.tsv'
        super().__init__(
...
if __name__ == '__main__':
    ...
    parser.add_argument("--checkpoint_dir", type=str, default='./ernie_checkpoint2',
    ...
    trainer = hub.Trainer(model, optimizer, checkpoint_dir=args.checkpoint_dir)
